...
if(!empty($_POST)) {
  ...
  $time = $_POST['time'];
  $contactNum = mysqli_real_escape_string($connectdb, $_POST['contactNum']);
  $address = mysqli_real_escape_string($connectdb, $_POST['address']);
  $postcode = mysqli_real_escape_string($connectdb, $_POST['postcode']);
  $state = mysqli_real_escape_string($connectdb, $_POST['state']);
  $name = mysqli_real_escape_string($connectdb, $_POST['name']);
  $itemDonate = mysqli_real_escape_string($connectdb, $_POST['itemDonate']);
  $city = mysqli_real_escape_string($connectdb, $_POST['city']);
  ...
  // Execute Query
  if(mysqli_query($connectdb, $save_db)) {
