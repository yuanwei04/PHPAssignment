...
<body>
	...
	<div class="heroImage">
		...
		<div class="heroText">
			...
			<a href="a-request.html"><button id="donateBtn">Donate</button></a>
			<a href="a-foodbankInfo.html"><button id="searchBtn">Search</button></a>
	...
	<div class="whoWeAre">
		...
		<a href="a-about.html"><button id="aboutBtn" onclick="a-about.html">LEARN MORE</button></a>
	...
	<div class="whatWeDo">
		...
		<div class="services">
			<div class="content content-1">
				...
				<img src="cashDonation.jpg" alt="Cash Donation Image">
				<p>
			...
			<div class="content content-2">
				...
				<img src="foodSecure.jpg" alt="Food Secure Image">
				<p>
			...
			<div class="content content-3">
				...
				<img src="foodDrive.jpg" alt="Food Drives">
				<p>
	...
	<div class="foodBankSection">
		...
		<button id="discoverBtn" onclick="a-foodbankInfo.html">DISCOVER NOW</button>
	...
	<div class="footer">
		...
		<div class="logo"><img src="Logo footer dark forest(edit).png"></div>
		<div class="infos"><br><br>
			<p>09-04 Bukit Jalil&nbsp;.&nbsp;Jalan Durian&nbsp;.&nbsp;Taman Impian Indah&nbsp;.&nbsp;57000 Kuala Lumpur</p>
			<hr>
		</div>
		<div class="infos">
			<div class="info">
			...
			<div class="info">
				<p>danielfin04@gmail.com</p>
			</div>
		</div>

		<div class="row">
			<div class="icon"><a href="#"><img src="facebook.png"></a></div>
			<div class="icon"><a href="#"><img src="instagram.png"></a></div>
			<div class="icon"><a href="#"><img src="twitter.png"></a></div>
		</div>
